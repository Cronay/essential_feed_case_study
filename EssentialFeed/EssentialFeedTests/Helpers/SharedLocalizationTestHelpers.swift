...
func assertLocalizedKeysAndValuesExists(in bundle: Bundle, table: String, file: StaticString = #filePath, line: UInt = #line) {
...
private func allLocalizedStringKeys(in bundles: [LocalizedBundle], table: String, file: StaticString, line: UInt) -> Set<String> {
