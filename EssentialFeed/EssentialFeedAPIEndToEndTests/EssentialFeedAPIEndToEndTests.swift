...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(imageFeed)?:
            XCTAssertEqual(imageFeed.count, 8, "Expected 8 images in the test account image feed, got \(imageFeed.count) instead")
    ...
    private func getFeedResult() -> FeedLoader.Result? {
        ...
        trackForMemoryLeaks(loader, file: #filePath, line: #line)
